  ...
  */
  public String endUp(String myString, int numToCap){
        if (numToCap > myString.length()) {
            ...
            String wantCapital = myString.substring(numToCap);
            int half1 = myString.length() / 2; 
            String half3 = myString.substring(0, half1);
            
            return myString.substring(0, myString.length() - numToCap) + wantCapital.toUpperCase();
        }
  }
